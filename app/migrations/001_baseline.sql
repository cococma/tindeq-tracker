-- Baseline: the original Tindeq tracker schema.
-- All IF NOT EXISTS, so this is a no-op on a database created from schema.sql.
...
CREATE TABLE IF NOT EXISTS baseline_tests (
    ...
    test_type     TEXT NOT NULL,  -- 'mvc_test' or 'rfd_test'
    grip_type     TEXT NOT NULL DEFAULT 'half_crimp',
    edge_depth_mm INTEGER NOT NULL DEFAULT 20,
    -- MVC
    peak_force_kg REAL,
